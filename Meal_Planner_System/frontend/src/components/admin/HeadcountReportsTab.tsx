    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="p-6 bg-gradient-to-br from-slate-700 to-slate-800 text-white rounded-xl shadow-lg">
                ...
                <div className="p-6 bg-gradient-to-br from-indigo-600 to-indigo-700 text-white rounded-xl shadow-lg">
                ...
                <div>
                    ...
                    <div className="grid gap-4">
                        {headcount.teamBreakdown.map((team) => (
                            <div key={team.teamId} className="p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">

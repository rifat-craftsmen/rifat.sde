...
import { mealUpdateValidation, scheduleValidation, userCreationValidation, userUpdateValidation } from '../middleware/validation';
const router = Router();
...
router.patch('/employee/:userId/record', authenticate, requireRole('LEAD', 'ADMIN'), requireTeamAccess, mealUpdateValidation, updateEmployeeMeals);
// Schedule management
